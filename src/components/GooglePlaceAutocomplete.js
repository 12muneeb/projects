...
const GooglePlaceAutocomplete = ({
  ...
  console.log(editprofile, 'editprofileeditprofile');
    ...
    <View style={[styles.geoLocationView, wrapperStyles]}>
      ...
      <View style={styles.inputContainer}>
        <GooglePlacesAutocomplete
          ...
          placeholder={editprofile ? valueEdit : 'Address'}
          placeholderTextColor={iconColor ? colors.secondary : colors.black}
          ...
          textInputProps={{
            ...
            placeholderTextColor: editprofile ? colors.black : colors.lightGray,
          }}
          query={{
            key: GEOCODE_API_KEY,
            language: 'en',
...
const styles = StyleSheet.create({
  ...
  textInput: {
    ...
    width: WP('100%'),
    // paddingRight: 10, // Add paddingRight to create space for the right icon
  },
